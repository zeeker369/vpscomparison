---
title: Alibaba Cloud Hangzhou — East China 1 (Hangzhou) Data Center
slug: alibaba-cloud-hangzhou-cn-east-1-data-center
aliases:
- /datacenter/alibaba-cloud-hangzhou-cn-east-1-data-center-2026/
- /datacenter/alibaba-cloud-hangzhou-cn-east-1-data-center-data-center-2026/
- /datacenter/alibaba-cloud-hangzhou-cn-east-1-data-center-datacenter-2026/
...
- **Should I use Hangzhou as an origin if my users are global?** Use CDN for static; for dynamic-heavy products, prefer multi-region or place origin near the largest user cluster.
