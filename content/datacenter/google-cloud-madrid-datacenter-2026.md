---
title: Google Cloud Madrid Data Center (2026)
slug: google-cloud-madrid-datacenter-2026
...
- Your users are mainly in **Europe** or near **Madrid**
- You need **data residency** close to Spain
...
- **Typical strategy:** origin in `europe-southwest1` + **CDN** for static + **API edge caching** where possible.
...
- [ ] Pick zone(s) inside `europe-southwest1` (multi-zone if you want HA)
