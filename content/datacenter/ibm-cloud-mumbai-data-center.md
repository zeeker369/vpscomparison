---
title: 'IBM Cloud Mumbai Data Center: Latency Reality, Zones & Deployment Checklist'
slug: ibm-cloud-mumbai-data-center
summary: What IBM Cloud Mumbai is best for, the routing reality, and a practical checklist
  to validate this metro before production.
description: 'IBM Cloud Mumbai data center guide: region code in-mum, zones, classic
...
lastmod: '2026-02-28'
aliases:
- /datacenter/ibm-cloud-mumbai-data-center-2026/
- /datacenter/ibm-mumbai-data-center/
- /datacenter/ibm-mumbai-data-center-2026/
- /datacenter/ibm-cloud-mumbai-airtel-data-center/
---

## Quick profile

- **Metro:** Mumbai, India
- **IBM programmatic region:** `in-mum`
- **Region type:** Single-campus Multizone Region (SC-MZR)
- **Zones (typical):** in-mum-1, in-mum-2, in-mum-3
- **Classic data center codes (common):** MUM02, MUM03, MUM05

This page is a **decision-first** guide for choosing IBM Cloud Mumbai as an origin location—focused on **routing reality**, **availability design**, and **cost traps**.

## Best for

- India West audiences and India locality requirements
- SC-MZR deployments in `in-mum` for HA within Mumbai metro
- India-first architectures with compliance/residency constraints
...
IBM Cloud’s **Mumbai** metro can work well for **Japan / APAC users**, but **mainland China traffic is ISP-dependent**:
...
Do not decide on Mumbai based on geography alone. Validate:
...
If Mumbai fails your routing tests, typical alternatives are:
...
### Should I use VPC or classic in Mumbai?
...
### What’s the fastest way to decide if Mumbai works?
