---
title: Google Cloud São Paulo Data Center (2026)
slug: google-cloud-são-paulo-datacenter-2026
...
- Your users are mainly in **South America** or near **São Paulo**
- You need **data residency** close to Brazil
...
- **Typical strategy:** origin in `southamerica-east1` + **CDN** for static + **API edge caching** where possible.
...
- [ ] Pick zone(s) inside `southamerica-east1` (multi-zone if you want HA)
