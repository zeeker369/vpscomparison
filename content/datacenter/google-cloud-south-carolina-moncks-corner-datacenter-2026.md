---
title: Google Cloud South Carolina (Moncks Corner) Data Center (2026)
slug: google-cloud-south-carolina-moncks-corner-datacenter-2026
...
- Your users are mainly in **North America** or near **South Carolina (Moncks Corner)**
...
- **Typical strategy:** origin in `us-east1` + **CDN** for static + **API edge caching** where possible.
...
- [ ] Pick zone(s) inside `us-east1` (multi-zone if you want HA)
