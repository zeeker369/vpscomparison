---
title: Google Cloud Oregon (The Dalles) Data Center (2026)
slug: google-cloud-oregon-the-dalles-datacenter-2026
...
- Your users are mainly in **North America** or near **Oregon (The Dalles)**
...
- **Typical strategy:** origin in `us-west1` + **CDN** for static + **API edge caching** where possible.
...
- [ ] Pick zone(s) inside `us-west1` (multi-zone if you want HA)
