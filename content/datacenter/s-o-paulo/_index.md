---
title: 'São Paulo Data Centers: Provider Comparison & Routing Notes'
slug: s-o-paulo
summary: A hub that aggregates São Paulo data center pages across providers, with
  a practical routing verification checklist and China picks tags.
description: 'São Paulo data centers hub: filter by provider/region, validate routing
...
This is the **São Paulo data center hub**. Use it to:
...
- Latency-sensitive apps with users in/near **São Paulo**
