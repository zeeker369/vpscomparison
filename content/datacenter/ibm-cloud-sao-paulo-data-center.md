---
title: 'IBM Cloud Sao Paulo Data Center: Latency Reality, Zones & Deployment Checklist'
slug: ibm-cloud-sao-paulo-data-center
summary: What IBM Cloud Sao Paulo is best for, the routing reality, and a practical
  checklist to validate this metro before production.
description: 'IBM Cloud Sao Paulo data center guide: region code br-sao, zones, classic
...
lastmod: '2026-02-28'
aliases:
- /datacenter/ibm-cloud-sao-paulo-data-center-2026/
- /datacenter/ibm-sao-paulo-data-center/
- /datacenter/ibm-sao-paulo-data-center-2026/
- /datacenter/ibm-cloud-sao-paulo-data-center/
---

## Quick profile

- **Metro:** Sao Paulo, Brazil
- **IBM programmatic region:** `br-sao`
...
- `br-sao` multi-zone designs for availability inside Brazil
- Workloads where regional data residency in Brazil is a requirement
