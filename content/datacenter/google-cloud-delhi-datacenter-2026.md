---
title: Google Cloud Delhi Data Center (2026)
slug: google-cloud-delhi-datacenter-2026
...
- Your users are mainly in **Asia Pacific** or near **Delhi**
...
- **Typical strategy:** origin in `asia-south2` + **CDN** for static + **API edge caching** where possible.
...
- [ ] Pick zone(s) inside `asia-south2` (multi-zone if you want HA)
