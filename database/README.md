...
## Current bootstrap (24 Aug 2026)

- 5 providers
- 6 product families
- 21 products
- 38 current price records
- 17 fully verified products
- 4 partial products (Vultr pricing awaits direct catalog/API verification)
