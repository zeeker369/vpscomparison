---
title: Google Cloud Santiago Data Center (2026)
slug: google-cloud-santiago-datacenter-2026
...
- Your users are mainly in **South America** or near **Santiago**
- You need **data residency** close to Chile
...
- **Typical strategy:** origin in `southamerica-west1` + **CDN** for static + **API edge caching** where possible.
...
- [ ] Pick zone(s) inside `southamerica-west1` (multi-zone if you want HA)
