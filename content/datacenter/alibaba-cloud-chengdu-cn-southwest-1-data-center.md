---
title: Alibaba Cloud Chengdu — Southwest 1 (Chengdu) Data Center
slug: alibaba-cloud-chengdu-cn-southwest-1-data-center
aliases:
- /datacenter/alibaba-cloud-chengdu-cn-southwest-1-data-center-2026/
- /datacenter/alibaba-cloud-chengdu-cn-southwest-1-data-center-data-center-2026/
- /datacenter/alibaba-cloud-chengdu-cn-southwest-1-data-center-datacenter-2026/
summary: 'Mainland China region (Southwest 1 (Chengdu)): best for China-domestic users,
  with ICP/compliance considerations.'
description: 'Alibaba Cloud Southwest 1 (Chengdu) data center (2026): who it''s for,
...
- **Location:** Chengdu (China (Mainland))
...
- **Should I use Chengdu as an origin if my users are global?** Use CDN for static; for dynamic-heavy products, prefer multi-region or place origin near the largest user cluster.
